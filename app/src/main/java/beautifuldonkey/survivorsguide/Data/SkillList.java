...
public class SkillList {
    ...
    static {
        ...
        skillList.add(new Skill("Black Market Connections", 5, "description", false,3,1,1));
        skillList.add(new Skill("Bless Weapon", 5, "description", false,3,1,1));
        skillList.add(new Skill("Blind Fighting", 5, "description", false,3,1,1));
        skillList.add(new Skill("Blinding", 5, "description", false,3,1,1));
        skillList.add(new Skill("Bolt Action", 5, "description", false,3,1,1));
        skillList.add(new Skill("Bomb Awareness", 5, "description", false,3,1,1));
        skillList.add(new Skill("Bounce", 5, "description", false,3,1,1));
        skillList.add(new Skill("Bow", 5, "description", false,3,1,1));
        skillList.add(new Skill("Brawling", 5, "description", false,3,1,1));
        skillList.add(new Skill("Break Armor", 5, "description", false,3,1,1));
        skillList.add(new Skill("Break Shield", 5, "description", false,3,1,1));
        skillList.add(new Skill("Break Weapon", 5, "description", false,3,1,1));
        skillList.add(new Skill("Brew Master", 5, "description", false,3,1,1));
        skillList.add(new Skill("Brewing", 5, "description", false,3,1,1));
        skillList.add(new Skill("Building Tomorrow", 5, "description", false,3,1,1));
        skillList.add(new Skill("Call The Almighty", 5, "description", false,3,1,1));
        skillList.add(new Skill("Carry", 5, "description", false,3,1,1));
        skillList.add(new Skill("Challenge", 5, "description", false,3,1,1));
        skillList.add(new Skill("Charge", 5, "description", false,3,1,1));
        skillList.add(new Skill("Charisma", 5, "description", false,3,1,1));
        skillList.add(new Skill("Chase", 5, "description", false,3,1,1));
        skillList.add(new Skill("Cheat", 5, "description", false,3,1,1));
        skillList.add(new Skill("Check Quality", 5, "description", false,3,1,1));
        skillList.add(new Skill("Check Status", 5, "description", false,3,1,1));
        skillList.add(new Skill("Check Value", 5, "description", false,3,1,1));
        skillList.add(new Skill("Check Your Sleeves", 5, "description", false,3,1,1));
        skillList.add(new Skill("Chocking Blow", 5, "description", false,3,1,1));
        skillList.add(new Skill("Chop", 5, "description", false,3,1,1));
        skillList.add(new Skill("Concentrated Fire", 5, "description", false,3,1,1));
        skillList.add(new Skill("Cover of Night", 5, "description", false,3,1,1));
        skillList.add(new Skill("Crop Tending", 5, "description", false,3,1,1));
        skillList.add(new Skill("Cure Toxins", 5, "description", false,3,1,1));
        skillList.add(new Skill("Deep Pockets", 5, "description", false,3,1,1));
        skillList.add(new Skill("Destroy Armor", 5, "description", false,3,1,1));
        skillList.add(new Skill("Destroy Shield", 5, "description", false,3,1,1));
        skillList.add(new Skill("Destroy Weapon", 5, "description", false,3,1,1));
        skillList.add(new Skill("Disarming Blow", 5, "description", false,3,1,1));
        skillList.add(new Skill("Disarming Shot", 5, "description", false,3,1,1));
        skillList.add(new Skill("Disguise", 5, "description", false,3,1,1));
        skillList.add(new Skill("Disguise Contents", 5, "description", false,3,1,1));
        skillList.add(new Skill("Double-Tap", 5, "description", false,3,1,1));
